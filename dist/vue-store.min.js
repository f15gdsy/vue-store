(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["StoreLite"] = factory();
	else
		root["StoreLite"] = factory();
})(this, function() {
...
var StoreLite = function () {
  function StoreLite(data) {
    var _this = this;

    _classCallCheck(this, StoreLite);

    this.core = new _vue2.default({
      data: data || {}
    });
    ...
    this.core.set = function () {
      return _this.set.apply(_this, arguments);
    };
    this.core.watch = function () {
      return _this.watch.apply(_this, arguments);
    };
  }

  _createClass(StoreLite, [{
    key: 'get',
    value: function get(key) {
      var val = key.split('.').reduce(indexGet, this.core);
...
function install(V, data) {
  var storeLite = new StoreLite(data);
